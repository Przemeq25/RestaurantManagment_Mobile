...
export const addProduct = (product) => {
  ...
  function addProduct(product) {
    return {type: basketConstants.ADD_PRODUCT, payload: product};
  }
};
export const deleteProduct = (productId) => {
  ...
  function deleteProduct(productId) {
    return {type: basketConstants.DELETE_PRODUCT, payload: productId};
  }
};
export const incrementProduct = (productId) => {
  ...
  function incrementProduct(productId) {
    return {type: basketConstants.INCREMENT_PRODUCT, payload: productId};
  }
};
export const decrementProduct = (productId) => {
  ...
  function decrementProduct(productId) {
    return {type: basketConstants.DECREMENT_PRODUCT, payload: productId};
  }
};
